package com.example.stockmanagement.productservice.exception;
...
public class ProductNotCreatedException extends RuntimeException{
    ...
    public ProductNotCreatedException(Language language, IFriendlyMessageCode friendlyMessageCode,String message) {
        ...
        log.error("[ProductNotCreatedException]-> message{}",FriendlyMessageUtils.getFriendlyMessage(language,friendlyMessageCode),message);
    }
}
